        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead className="bg-green-50 text-green-800 font-bold">
              <tr>{[t("thRank"), t("thName"), t("thClass"), "Level", t("thScore")].map((h) => (
            ...
            <tbody>
              {loading ? (
                ...
                <tr><td colSpan={5}><Empty icon="🏆" text={t("empty")} /></td></tr>
                ...
                <tr key={s.id} className={`border-t border-green-50 ${rank < 3 ? "bg-yellow-50/50" : "hover:bg-green-50/50"}`}>
                  <td className="px-4 py-3 font-serif font-bold text-xl">{rank < 3 ? ranks[rank] : `#${rank + 1}`}</td>
                  ...
                  <td className="px-4 py-3 font-serif font-bold text-xl text-green-700">{s.score.toLocaleString()}</td>
                </tr>
                );
              })}
            </tbody>
