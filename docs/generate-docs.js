  ...
  const doc = new Document({
    ...
    sections: [{
      children: [
        ...
        h3("อนุมัติคำขอลงทะเบียน (Approve Pending Registrations)"),
        p("นักเรียนสามารถสมัครบัญชีด้วยตนเองได้เช่นกัน (ดูหัวข้อ 4.1) โดยบัญชีที่สมัครใหม่จะยัง Login ไม่ได้จนกว่าครูจะอนุมัติ"),
        bullet("คำขอที่รออนุมัติจะแสดงในแผง 🕐 คำขอลงทะเบียนที่รออนุมัติ ด้านบนของหน้านี้ พร้อมรหัสนักเรียน ชื่อ และห้องเรียน"),
        bullet("คลิก ✅ อนุมัติ เพื่อเปิดใช้งานบัญชี — นักเรียนจะสามารถ Login ได้ทันที"),
        bullet("คลิก ✖ ปฏิเสธ เพื่อลบคำขอทิ้งอย่างถาวร (เช่น ข้อมูลซ้ำหรือปลอม)"),
        p("หมายเหตุ: แผงนี้จะซ่อนอัตโนมัติเมื่อไม่มีคำขอค้างอยู่", { italics: true, color: "888888" }),
        ...
        h2("4.1 สร้างบัญชี (ลงทะเบียนด้วยตนเอง) — /signup/student"),
        p("หากยังไม่มีครูเพิ่มชื่อให้ นักเรียนสามารถสมัครบัญชีเองได้:"),
        bullet("จากหน้า Login นักเรียน คลิก ลงทะเบียนนักเรียนใหม่"),
        bullet("กรอก รหัสนักเรียน (เลือกเอง เช่น STD010), ชื่อ-นามสกุล, ห้องเรียน, และ รหัสผ่าน (อย่างน้อย 6 ตัวอักษร, กรอกยืนยัน 2 ครั้ง)"),
        bullet("คลิก ลงทะเบียน"),
        p("หมายเหตุ: บัญชีจะถูกสร้างในสถานะ 'รออนุมัติ' และยัง Login ไม่ได้จนกว่าครูจะอนุมัติ (ดูหัวข้อ 3.2) หากพยายาม Login ก่อนได้รับอนุมัติ ระบบจะแจ้ง 'บัญชีของคุณกำลังรอครูอนุมัติ'", { italics: true, color: "888888" }),

        h2("4.2 Login ครั้งแรก — การเปลี่ยนรหัสผ่าน"),
        p("นักเรียนที่ครูเพิ่มให้โดยตรงจะมีรหัสผ่านเริ่มต้น = รหัสนักเรียน (เช่น STD001) ขั้นตอนนี้ไม่จำเป็นสำหรับผู้ที่ลงทะเบียนด้วยตนเอง เนื่องจากตั้งรหัสผ่านของตัวเองไว้แล้ว"),
        ...
        makeTable(
          ...
          [
            ...
            ["ข้อความ 'บัญชีของคุณกำลังรอครูอนุมัติ' (นักเรียน)", "บัญชีที่ลงทะเบียนด้วยตนเองยังรออนุมัติ; แจ้งครูให้อนุมัติในหน้าจัดการนักเรียน"],
